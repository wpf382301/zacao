...
def inference_3conv(images, batch_size, n_classes):
...
def inference_3conv_direct_without_dropout(images, batch_size, n_classes):
    # with tf.name_scope('images'):
    #     tf.summary.image('images', images, batch_size)
    with tf.variable_scope('conv1'):
        weights = tf.get_variable('weights', shape=[3, 3, 3, 32], dtype=tf.float32, initializer=tf.truncated_normal_initializer(stddev=0.1, dtype=tf.float32))
...
def inference_3conv_direct(images, batch_size, n_classes):
    # with tf.name_scope('images'):
    #     tf.summary.image('images', images, batch_size)
    with tf.variable_scope('conv1'):
        weights = tf.get_variable('weights', shape=[3, 3, 3, 32], dtype=tf.float32, initializer=tf.truncated_normal_initializer(stddev=0.1, dtype=tf.float32))
...
def inference_direct(images, batch_size, n_classes):
    # with tf.name_scope('images'):
    #     tf.summary.image('images', images, batch_size)
    with tf.variable_scope('conv1'):
        weights = tf.get_variable('weights', shape=[3, 3, 3, 32], dtype=tf.float32,
...
def inference_direct_without_dropout(images, batch_size, n_classes):
    # with tf.name_scope('images'):
    #     tf.summary.image('images', images, batch_size)
    with tf.variable_scope('conv1'):
        weights = tf.get_variable('weights', shape=[3, 3, 3, 32], dtype=tf.float32,
